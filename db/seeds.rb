...
jean = Item.create!(name: "jean", url:"www.jean.com", photo: File.open('app/assets/images/jean_image.jpg'))
snowjacket = Item.create!(name:"snowjacket", url:"snowjacket.com", photo: File.open('app/assets/images/snow_jacket.jpg'))
sunglasses = Item.create!(name:"sunglasses", url:"sun_glasses.com", photo: File.open('app/assets/images/sun_glasses.jpg'))
sunhat = Item.create!(name:"sunhat", url:"sunhat.com", photo: File.open('app/assets/images/sun_hat.jpg'))
